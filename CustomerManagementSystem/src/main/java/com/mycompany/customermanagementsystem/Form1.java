...
public class Form1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Lead Customer", "Regular Customer" }));
        ...
        jLabel7.setText("Validation Result ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jComboBox1.getSelectedItem().equals("Lead Customer")){
         if(jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty()){
        jLabel7.setText("Customer name and phone number  are required ! " );
         } 
         else {
             jLabel7.setText("Success ! " );
         }
       }
       else if (jComboBox1.getSelectedItem().equals("Regular Customer")){
          if(jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty() || jTextField3.getText().isEmpty() || 
                  jTextField4.getText().isEmpty() || jTextField5.getText().isEmpty()){
        jLabel7.setText("All are required ! " );
         }
          else {
